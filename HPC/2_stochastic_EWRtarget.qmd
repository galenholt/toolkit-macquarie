...
Set up parallel structure. i don't actually need the workers, I don't think, but I'll keep one to get the cores. 

```{r}
# furrr is losing globals, and it's fast enough to just ignore.
...
# actually, furrr is stuffing up globals somehow, and it's fast enough without it.
# if (Sys.info()['user'] == 'hol436') {
