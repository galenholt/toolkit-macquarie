...
This repository contains the code for analyses for the Macquarie climate and adaptation case study. It uses the HydroBOT toolkit @Holt_HydroBOT_Toolkit_For to analyse hydrograph and economic data for *Synergies in water availability, the environment, and agricultural output under climate change and adaptation* (in review)*.*
...
To rebuild the environments as in the paper, we need to set up python and R.
...
3.  Build environment with pinned versions of HydroBOT (`r packageVersion('HydroBOT`) and py-ewr (`r HydroBOT::get_ewr_version()`).
    ...
    -   Run the `project_setup.bat` file, which will install the versions of both HydroBOT and its python dependencies (the [EWR tool](https://pypi.org/project/py-ewr/)) used for the manuscript (py-ewr version 2.1.6).
